...
type MemoryStore struct {
	...
	healthReviewDetails   map[string]model.HealthReview
	healthReviewSummaries map[string]model.HealthReview
}
...
func NewMemoryStore() *MemoryStore {
	return &MemoryStore{
		...
		healthReviewDetails:   make(map[string]model.HealthReview),
		healthReviewSummaries: make(map[string]model.HealthReview),
	}
}
